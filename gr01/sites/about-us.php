  ...
  <div class="section-background-first">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-center">
            <img style="width:400px; height:auto; border-radius: 5px;" src="/gr01/src/assets/aboutusimg.jpg" alt="Our Story Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="trusted-by" class="py-5">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <img src="/gr01/src/assets/organizer-logo1.png" alt="Logo 1" class="img-fluid mx-auto d-block">
          </div>
          <div class="col-md-4">
            <img src="/gr01/src/assets/organizer-logo2.png" alt="Logo 2" class="img-fluid mx-auto d-block">
          </div>
          <div class="col-md-4">
            <img src="/gr01/src/assets/organizer-logo3.png" alt="Logo 3" class="img-fluid mx-auto d-block">
          </div>
        </div>
      </div>
    </section>

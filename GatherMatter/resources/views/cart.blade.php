                            ...
                            <div class="row g-0">
                                <div class="col-lg-8">
                                    <div class="p-5">
                                            ...
                                            <div class="row mb-4 d-flex align-items-center">
                                                <div class="col-md-2 col-lg-2 col-xl-2">
                                                    @if($item->ticket->event->image_path)
                                                        <img
                                                            src="{{ asset('storage/' . $item->ticket->event->image_path) }}"
                                                            class="img-fluid rounded-3" alt="Event Image">
                                                    @endif
                                                </div>
                                                <div class="col-md-3 col-lg-3 col-xl-3">
                                                ...
                                                <div class="col-md-2 col-lg-2 col-xl-2">
                                                    <h6 class="text-black mb-0"> € {{ $item->ticket->price }}</h6>
                                        ...
                                        @endforeach
                                        <div class="pt-5">
                                            <h6 class="mb-0"><a href="{{ route('events.index') }}" class="text-body"><i
                                            ...
                                            <div class="row" style="padding: 18px;" id="paypalbtn">
                                                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr"
                                                    ...
                                                    <input type="hidden" name="business"
                                                           value="sb-dpw9a26241586@business.example.com">
                                                    ...
                                                    <input type="hidden" name="return"
                                                           value="{{ url('paypal/success') }}">
                                                    <input type="hidden" name="cancel_return"
                                                           value="{{ url('paypal/cancel') }}">
                                                    ...
                                                    <input type="image"
                                                           ...
                                                           alt="Pay Now" style="cursor: pointer;">
                                                    <img alt="" src="https://paypalobjects.com/en_US/i/src/pixel.gif"
                                                         width="1" height="1" style="cursor: pointer;">
                                                </form>
                                            </div>
                                        </div>
                                    </div>

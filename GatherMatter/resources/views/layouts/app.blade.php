            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <div style="position: relative; max-width: 35%;">
                    <form class="d-flex mt-2 mt-lg-0" role="search" id="search-form">
                        <input class="form-control me-2" type="search" placeholder="Search in Events"
                               aria-label="Search" style="height: 30px;" id="search-input">
                    ...
                    <div id="search-results" class="position-absolute bg-white p-2 mt-2"
                         style="display: none; z-index: 999; right: 0;"></div>
                </div>
                    ...
                    @guest
                        @if (Route::has('login'))
                            <button onclick="window.location.href='{{ route('login') }}';" type="button"
                                    class="btn btn-sm btn-secondary" style="margin-right: 5px;">Login
                            </button>
                        @endif
    ...
    <div class="container">
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                ...
                <li class="nav-item"><a href="{{ route('terms') }}" class="nav-link px-2 text-muted">Terms &
                        Conditions</a></li>
                <li class="nav-item"><a href="{{ route('privacypolicy') }}" class="nav-link px-2 text-muted">Privacy
                        policy</a></li>
            </ul>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="cookie-message text-center">
                    <p class="mb-3">We use cookies to enhance your experience on our website. By continuing to browse
                        this site, you consent to the use of cookies.</p>
                    <p class="text-muted">Please note that by not accepting cookies, some features and functionalities
                        of the website may be limited.</p>

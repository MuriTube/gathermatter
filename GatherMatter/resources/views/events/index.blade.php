                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="card h-100 shadow">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="card-subtitle mb-2 text-muted">Organized
                                                by: {{ $event->organizer->name }}</h5>
                                            <b>
                                                Beginn:
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('events.show', $event) }}"
                                               class="btn btn-primary mb-2 mb-md-0">View Details</a>
                                            @if(Auth::user()->role === 'organizer')
                                                <div class="btn-group">
                                                    ...
                                                    <form action="{{ route('events.destroy', $event) }}" method="POST"
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger ml-md-2">Delete
                                                        </button>
                                                    </form>
                                                </div>
                                            @endif
                    ...
                    <div class="dropdown">
                        <form action="{{ route('events.index') }}" method="GET" class="d-inline">
                            <select name="sort" onchange="this.form.submit()" class="form-select">
                                ...
                                <option value="title" {{ request('sort') === 'title' ? 'selected' : '' }}>Sort by
                                    title
                                </option>
                            </select>
                        </form>

            ...
            <div class="col-md-10">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="card h-100 shadow">
                                        ...
                                        <div class="card-footer d-flex flex-column flex-md-row justify-content-between align-items-center bg-white">
                                            <a href="{{ route('events.show', $event) }}" class="btn btn-primary mb-2 mb-md-0">View Details</a```html
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    @if(Auth::user() && Auth::user()->role === 'admin')
                        <a href="{{ route('events.create') }}" class="btn btn-secondary">Create New Event</a>
                    @else
                        <div style="width: 140px;"> <!-- Placeholder with the same width as the button -->
                            <!-- Empty content -->
                        </div>
                    @endif
                </div>
                                ...
                                <div class="card h-100 shadow">
                                    ...
                                    <div class="card-footer d-flex flex-column flex-md-row justify-content-between align-items-center bg-white">
                                        ...
                                        @if(Auth::user() && Auth::user()->role === 'admin')
                                            <div class="btn-group">
                                                <a href="{{ route('events.edit', $event) }}" class="btn btn-secondary ml-md-2">Edit</a>
                                                <form action="{{ route('events.destroy', $event) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to```html
